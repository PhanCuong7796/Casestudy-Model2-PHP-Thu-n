...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form class="search-form" action="categories-search.php" method="POST">
                        ...
                        <nav class="dataTable-pagination">
                            <ul class="dataTable-pagination-list">
                                ...
                                if ($current_page > 1 && $total_page > 1) {
                                    echo '<li><a href="categories-list.php?page=' . ($current_page - 1) . '">Prev</a></li>';
                                }
                                for ($i = 1; $i <= $total_page; $i++) {
                                    if ($i == $current_page) {
                                        echo '<a>' . $i . '</a>';
                                    } else {
                                        echo '<li><a href="categories-list.php?page=' . $i . '">' . $i . '</a></li>';
                                    }
                                }
                                if ($current_page < $total_page && $total_page > 1) {
                                    echo '<li><a href="categories-list.php?page=' . ($current_page + 1) . '">Next</a></li>';
                                }
                                ?>
                            </ul>
                        </nav>
