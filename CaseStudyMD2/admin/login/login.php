                                ...
                                <div class="card-body">
                                    <form method="post" action="">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="input">Địa Chỉ Email</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" id="inputRememberPassword" type="checkbox" name="rememberpassword" value="" />
                                            <label class="form-check-label" for="inputRememberPassword">Nhớ Mật Khẩu</label>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" href="../login/resetpassword.php">Quên Mật Khẩu?</a>
